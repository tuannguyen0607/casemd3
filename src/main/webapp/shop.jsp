            ...
            <div class="d-inline-flex align-items-center">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a  href="loginproduct.jsp" class="dropdown-item" type="button">Sign in</a>
                       <a   href="Register.jsp" class="dropdown-item" type="button">Sign up</a>
                    </div>
                </div>
    ...
    <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
        <div class="col-lg-4">
            <a href="" class="text-decoration-none">
                <span class="h1 text-uppercase text-primary bg-dark px-2">Tuấn</span>
                <span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">Nguyễn</span>
            </a>
        </div>
        ...
        <div class="col-lg-3 d-none d-lg-block">
            ...
            <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light"
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/ProductCategoryServlet?idcategory=${c.id_Category}" class="nav-item nav-link">${c.style}</a>
                    </c:forEach>
                </div>
            </nav>
        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src=${sp.img} alt="">
                                <div class="product-action">
                                    <a class="btn btn-outline-dark btn-square" href="/addCart?action=add&id=${sp.id_product}"><i
                            ...
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate" href="">${sp.nameproduct}</a>
