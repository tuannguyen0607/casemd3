...
<head>
    ...
    /*-- end reset --*/
    body {
        background-image: url(https://cdn.hubs.vn/pv-blog/https://cdn.hubs.vn/pv-blog/2018/07/2.jpg);
    ...
    <div class="main-agileinfo">
        <div class="agileits-top">
            <form action="/Register" method="post">
                <input class="text email" type="email" name="gmail" placeholder="Email" required="">
                <input class="text" type="text" name="userName" placeholder="User Name" required=""></br>
                <input class="text" type="password" name="passWord" placeholder="Password" required="">
                <input class="text w3lpass" type="password" name="ConfirmPassword" placeholder="Confirm Password" required="">
                <input class="text " type="text" name="number" placeholder="Phone Number" required="">
            ...
            <p>You already had an account? <a href="loginproduct.jsp"> Login Now!</a></p>
        </div>
    </div>
</div>
</body>
